...
/*
  GrooveMatch — UNIFIED BUILD (merge1, 2025-09-04)
  ------------------------------------------------
  This file merges:
  • LIVE base you provided (our clean build)
  • USER script (your prior patches: submit modal sync, pattern UI, admin pending/approve fixes, audio bridge, etc.)
  Merge rules:
  - Keep LIVE as the base.
  - Layer USER patches after base (they have guards like window.__GM_* to avoid double-binding).
assignDeepSafe(()=>(- Replace any optional-chaining assignments (e.g., obj), 'prop', val) with safe deep assignment.
*/
