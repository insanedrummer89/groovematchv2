...
/* Any .btn that looks “primary-ish” gets brand blue */
.btn:not(.outline):not(.secondary),
button.btn:not(.outline):not(.secondary),
a.btn:not(.outline):not(.secondary) {
  background-color: var(--gm-blue) !important;
  border-color: var(--gm-blue) !important;
  color: #fff !important;
}
.btn:not(.outline):not(.secondary):hover,
button.btn:not(.outline):not(.secondary):hover,
a.btn:not(.outline):not(.secondary):hover {
  background-color: var(--gm-blue-hov) !important;
  border-color: var(--gm-blue-hov) !important;
}

/* Play buttons regardless of ID/class soup */
button[id*="play"],
button[class*="play"],
...
/* When pressed/toggled */
button[aria-pressed="true"],
#admPlay[aria-pressed="true"] {
  background-color: var(--gm-blue-act) !important;
  border-color: var(--gm-blue-act) !important;
  color: #fff !important;
}

/* Kill browser default blue outlines/highlight on tap */
button, .btn, a.btn {
